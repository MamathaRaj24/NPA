   ...
   <title>SVPNPA</title>
    ...
    <script type="text/javascript">
        function Confirm(link) {
            if (confirm("Are you sure to delete the selected Qualification")) {
                return true;
            }
            else
                return false;
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'Mst_Qualification.aspx');
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Qualification Master</strong>
                            </div>
                            <div class="card-body card-block">
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-4">
                                        <asp:TextBox ID="txtQualification" CssClass="form-control" autocomplete="Off" MaxLength="50"
                                            runat="server">
                                        </asp:TextBox>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="txtQualification_FilteredTextBoxExtender"
                                            runat="server" BehaviorID="txtQualification_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                            TargetControlID="txtQualification" ValidChars=" .,()-">
                                ...
                                <div class="row form-group offset-4">
                                    <asp:GridView ID="GvQual" runat="server" CssClass="table table-striped table-bordered"
                                        GridLines="None" AutoGenerateColumns="False" OnRowCommand="GvQual_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Qualification">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblQualificationId" runat="server" Visible="false" Text='<%# Bind("Qualification_Code") %>'>
                                                    </asp:Label>
                                                    <asp:Label ID="lblQualificationName" runat="server" Text='<%# Bind("Qualification_Name") %>'>
                                                    </asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
