<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddItems_Section.aspx.cs"
    Inherits="SectionHead_AddItems_Section" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'AddItems_Section.aspx');
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Add Items in Section</strong>
                            </div>
                            <div class="card-body card-block">
                                <div class="row form-group text-center">
                                    ...
                                    <div class=" col-md-4">
                                        <asp:TextBox ID="txtItemname" CssClass="form-control" autocomplete="Off" MaxLength="150"
                                            runat="server" placeholder="Enter Item Name">
                                        </asp:TextBox>
                                    </div>
                                </div>
                                <div class="text-center">
                                    ...
                                    <asp:Button ID="btn_Save" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="btn_Save_Click1" />
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Section Name">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblsectioncode" Visible="false" runat="server" Text='<%# Bind("SectionID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
