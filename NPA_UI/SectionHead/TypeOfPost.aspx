<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TypeOfPost.aspx.cs"
    Inherits="SectionHead_TypeOfPost" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'TypeOfPost.aspx');
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-4">
                                        <asp:TextBox ID="txtPosttypename" CssClass="form-control" AutoComplete="off" runat="server"
                                            placeholder="Enter Post Type Name"></asp:TextBox>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="txtPosttypename_FilteredTextBoxExtender"
                                            runat="server" BehaviorID="txtPosttypename_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                            TargetControlID="txtPosttypename" ValidChars=" .,()-">
                ...
                <div class="row form-group">
                    <div class="col col-md-6">
                        <div class="table-responsive">
                            <asp:GridView ID="GVPostType" runat="server" CssClass="table table-striped table-bordered dataTable no-footer"
                                GridLines="None" AutoGenerateColumns="False" OnRowCommand="GVPostType_RowCommand">
                                <Columns>
                                    <asp:TemplateField HeaderText="Section Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblpostType" runat="server" Text='<%# Bind("PostTypeName") %>'></asp:Label>
                                            <asp:Label ID="lblpostTypecode" runat="server" Visible="false" Text='<%# Bind("PostTypeID") %>'> </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
