...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'Leave_Details.aspx');
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Applied Leave Status Details</strong>
                            </div>
                                        ...
                                        <asp:GridView ID="GvLeave" runat="server" CssClass="footable" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Status">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("Status") %>'></asp:Label><br />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:Button ID="btnCancel" runat="server" Enabled='<%# Eval("Flag").ToString()=="1" ? true  :  false %>'
                                                            CommandArgument="C" CssClass="btn btn-info rounded" Text="Cancel" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
