                                ...
                                <div class="row form-group">
                                    <div class="col col-md-2">
                                        <label class=" form-control-label">
                                            Select User Type (In Application)</label></div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GVUsers" runat="server" CssClass="table table-striped table-bordered dataTable no-footer"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Login User Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbluserName" runat="server" CssClass="text-primary" Text='<%# Bind("UserName") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Usertype">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRoleName" runat="server" Text='<%# Bind("RoleName") %>' />
                                                            <asp:Label ID="lblRoleId" Text='<%# Eval("Role_Id") %>' Visible="false" runat="server"> </asp:Label>
                                                            <asp:Label ID="lblUserId" Text='<%# Eval("UserID") %>' Visible="false" runat="server"> </asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Emplyoee">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblEmpId" Visible="false" runat="server" Text='<%# Bind("code") %>' />
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnedit" runat="server" class="btn btn-primary rounded" CommandName="edt"
                                                                Text="Edit" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnDel" runat="server" class="btn btn-primary rounded" CommandName="dlt"
