...
public partial class CreatePost : System.Web.UI.Page
{
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (validate())
            {
                ...
                objBE.Signature = rblSign.SelectedValue;
    ...
    protected void rblFee_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rblFee.SelectedValue == "1")
            txtFee.Enabled = true;
        else
        {
            txtFee.Text = "";
